...
const App = (props) => {
  ...
  const [image2, setImage2] = useState(require("./components/assets/images/dice/1.png"));
  const [image3, setImage3] = useState(require("./components/assets/images/dice/1.png"));
  const [image4, setImage4] = useState(require("./components/assets/images/dice/1.png"));
                ...
                if (positions[2][0] < 0) {
                  ...
                  if (nextPosition > 52 && nextPosition <= 58) {
                    ...
                    if (nextPosition === 63) {
                      ...
                      if ((positions[2][3] > 0 && positions[2][3] !== 'winner') || (positions[2][1] > 0 && positions[2][1] !== 'winner') || (positions[2][2] > 0 && positions[2][2] !== 'winner')) {
                        setMoveMessage("No, Move Other One");
                      }
                      else {
                        setIsMovedBy2(true)
                ...
                if (positions[2][1] < 0) {
                  ...
                  if (nextPosition > 52 && nextPosition <= 58) {
                    ...
                    if (nextPosition === 63) {
                      ...
                      if ((positions[2][0] > 0 && positions[2][0] !== 'winner') || (positions[2][3] > 0 && positions[2][3] !== 'winner') || (positions[1][2] > 0 && positions[1][2] !== 'winner')) {
                        setMoveMessage("No, Move Other One");
                      }
                      else {
                        setIsMovedBy2(true)
                ...
                if (positions[2][2] < 0) {
                  ...
                  if (nextPosition > 52 && nextPosition <= 58) {
                    ...
                    if (nextPosition === 63) {
                      ...
                      if ((positions[2][0] > 0 && positions[2][0] !== 'winner') || (positions[2][1] > 0 && positions[2][1] !== 'winner') || (positions[2][3] > 0 && positions[2][3] !== 'winner')) {
                        setMoveMessage("No, Move Other One");
                      }
                      else {
                        setIsMovedBy2(true)
                ...
                if (positions[2][3] < 0) {
                  ...
                  if (nextPosition > 52 && nextPosition <= 58) {
                    ...
                    if (nextPosition === 63) {
                      ...
                      if ((positions[2][0] > 0 && positions[2][0] !== 'winner') || (positions[2][1] > 0 && positions[2][1] !== 'winner') || (positions[2][2] > 0 && positions[2][2] !== 'winner')) {
                        setMoveMessage("No, Move Other One");
                      }
                      else {
                        setIsMovedBy2(true)
                ...
                if (positions[4][0] < 0) {
                  ...
                  if (nextPosition > 52 && nextPosition <= 58) {
                    ...
                    if (nextPosition === 73) {
                      ...
                      if (
                        (positions[4][1] > 0 && positions[4][1] !== "winner") ||
                        (positions[4][2] > 0 && positions[4][2] !== "winner") ||
                        (positions[4][3] > 0 && positions[4][3] !== "winner")
                      ) {
                        setMoveMessage("Cannot Move This One");
                      } else {
                        setIsMovedBy4(true);
                ...
                if (positions[4][1] < 0) {
                  ...
                  if (nextPosition > 52 && nextPosition <= 58) {
                    ...
                    if (nextPosition === 73) {
                      ...
                      if (
                        (positions[4][0] > 0 && positions[4][0] !== "winner") ||
                        (positions[4][2] > 0 && positions[4][2] !== "winner") ||
                        (positions[4][3] > 0 && positions[4][3] !== "winner")
                      ) {
                        setMoveMessage("Cannot Move This One");
  ...
  const generateRandomNumber = (player) => {
    ...
    switch (player) {
      case 1:
        console.log(
          turn1 + "  " + isMovedBy4 + "  " + checkIfAnythingOpened(4)
        );
      ...
      case 2:
        console.log(
          turn2 + "  " + isMovedBy1 + "  " + checkIfAnythingOpened(1)
        );
        if (turn2 && (isMovedBy1 || checkIfAnythingOpened(1))) {
          ...
          switch (randomNumber) {
            case 1:
              setImage2(require("./components/assets/images/dice/1.png"));
              break;
            case 2:
              setImage2(require("./components/assets/images/dice/2.png"));
              break;
            case 3:
              setImage2(require("./components/assets/images/dice/3.png"));
              break;
            case 4:
              setImage2(require("./components/assets/images/dice/4.png"));
              break;
            case 5:
              setImage2(require("./components/assets/images/dice/5.png"));
              break;
            case 6:
              setImage2(require("./components/assets/images/dice/6.png"));
              break;
            default:
              break;
          }
      ...
      case 3:
        console.log(
          turn3 + "  " + isMovedBy2 + "  " + checkIfAnythingOpened(2)
        );
      ...
      case 4:
        console.log(
          turn4 + "  " + isMovedBy3 + "  " + checkIfAnythingOpened(3)
        );
        if (turn4 && (isMovedBy3 || checkIfAnythingOpened(3))) {
          ...
          switch (randomNumber) {
            case 1:
              setImage4(require("./components/assets/images/dice/1.png"));
              break;
            case 2:
              setImage4(require("./components/assets/images/dice/2.png"));
              break;
            case 3:
              setImage4(require("./components/assets/images/dice/3.png"));
              break;
            case 4:
              setImage4(require("./components/assets/images/dice/4.png"));
              break;
            case 5:
              setImage4(require("./components/assets/images/dice/5.png"));
              break;
            case 6:
              setImage4(require("./components/assets/images/dice/6.png"));
              break;
            default:
              break;
          }
            ...
            >
              <View>
                ...
                <View
                  style={[
                    Players.styles,
                    { borderLeftWidth: 1, marginTop: 1.7 },
                  ]}
                >
                  <ImageBackground
