      ...
      switch(player){
        ...
        case 2  :
            ...
            if(this.state.turn2 && (this.state.isMovedBy1 || this.checkIfAnythingOpened(1))){
              ...
              switch(randomNumber){
                case 1 : 
                  this.setState({image2 : require("./components/assets/images/dice/1.png")})
                  break;
                case 2 : 
                  this.setState({image2 : require("./components/assets/images/dice/2.png")})
                  break;
                case 3 : 
                  this.setState({image2 : require("./components/assets/images/dice/3.png")})
                  break;
                case 4 : 
                  this.setState({image2 : require("./components/assets/images/dice/4.png")})
                  break;
                case 5 : 
                  this.setState({image2 : require("./components/assets/images/dice/5.png")})
                  break;
                case 6 : 
                  this.setState({image2 : require("./components/assets/images/dice/6.png")})
                  break;
              }
              if(randomNumber != 6){
            ...
            if(this.state.turn3 && (this.state.isMovedBy2 || this.checkIfAnythingOpened(2))){
              ...
              switch(randomNumber){
                case 1 : 
                  ...
                  break;
                case 2 : 
                  this.setState({image3 : require("./components/assets/images/dice/2.png")})
                  break;
                case 3 : 
                  this.setState({image3 : require("./components/assets/images/dice/3.png")})
                  break;
                case 4 : 
                  this.setState({image3 : require("./components/assets/images/dice/4.png")})
                  break;
                case 5 : 
                  this.setState({image3 : require("./components/assets/images/dice/5.png")})
                  break;
                case 6 : 
                  this.setState({image3 : require("./components/assets/images/dice/6.png")})
                  break;
              }
              if(randomNumber != 6){
        ...
        case 4:
            ...
            if(this.state.turn4 && (this.state.isMovedBy3 || this.checkIfAnythingOpened(3))){
              ...
              switch(randomNumber){
                case 1 : 
                  this.setState({image4 : require("./components/assets/images/dice/1.png")})
                  break;
                case 2 : 
                  this.setState({image4 : require("./components/assets/images/dice/2.png")})
                  break;
                case 3 : 
                  this.setState({image4 : require("./components/assets/images/dice/3.png")})
                  break;
                case 4 : 
                  this.setState({image4 : require("./components/assets/images/dice/4.png")})
                  break;
                case 5 : 
                  this.setState({image4 : require("./components/assets/images/dice/5.png")})
                  break;
                case 6 : 
                  this.setState({image4 : require("./components/assets/images/dice/6.png")})
                  break;
              }
              if(randomNumber != 6){
